...
function LoginForm() {
  ...
  const redirect = searchParams.get("redirect") ?? EDUGUIA_ROUTES.home;
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(redirect.startsWith("/dashboard") ? redirect : EDUGUIA_ROUTES.home);
      router.refresh();
    } catch {
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <Link
                  href={EDUGUIA_ROUTES.forgotPassword}
...
export default function EduguiaLoginPage() {
  return (
    <Suspense
      fallback={
        <div className="relative flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-background to-muted/30 p-4">
