...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "progress.reportLanguage": "Report language",
    "progress.shareWithFamily": "Share with family",
    "progress.shareWithFamilyHint": "Generate a private link (30 days) with the report in Spanish and Kaqchikel summary for parents.",
    "progress.shareCreateLink": "Create family link",
    "progress.shareCreating": "Creating link…",
    "progress.shareCopy": "Copy link",
    "progress.shareCopied": "Copied!",
    "progress.shareLinkLabel": "Family share link",
    "progress.shareExpires": "Expires",
    "progress.shareRevoke": "Revoke link",
    "progress.shareError": "Could not create share link.",
    "progress.shareRevokeError": "Could not revoke link.",
    "progress.chatSavedCloud": "Chat history is saved in sesiones_chat (cloud) when signed in.",
    ...
    "toolkit.externalResources": "Guides, videos and PDFs",
    "toolkit.externalResourcesHint": "Curated resources for inclusive education (open in new tab).",
    "toolkit.scratchTitle": "Scratch — creative coding",
    "toolkit.scratchDesc": "Free platform to learn programming with visual blocks.",
    "toolkit.inclusionGtTitle": "Inclusive education — UNICEF Guatemala",
    "toolkit.inclusionGtDesc": "Official information on education and inclusion in Guatemala.",
  ...
  es: {
    ...
    "progress.reportLanguage": "Idioma del informe",
    "progress.shareWithFamily": "Compartir con la familia",
    "progress.shareWithFamilyHint": "Genera un enlace privado (30 días) con el informe en español y resumen en Kaqchikel para padres.",
    "progress.shareCreateLink": "Crear enlace para familia",
    "progress.shareCreating": "Creando enlace…",
    "progress.shareCopy": "Copiar enlace",
    "progress.shareCopied": "¡Copiado!",
    "progress.shareLinkLabel": "Enlace para compartir con la familia",
    "progress.shareExpires": "Expira",
    "progress.shareRevoke": "Revocar enlace",
    "progress.shareError": "No se pudo crear el enlace.",
    "progress.shareRevokeError": "No se pudo revocar el enlace.",
    "progress.chatSavedCloud": "El historial de chat se guarda en sesiones_chat (nube) al iniciar sesión.",
    ...
    "toolkit.externalResources": "Guías, videos y PDFs",
    "toolkit.externalResourcesHint": "Recursos seleccionados para educación inclusiva (se abren en otra pestaña).",
    "toolkit.scratchTitle": "Scratch — programación creativa",
    "toolkit.scratchDesc": "Plataforma gratuita para aprender programación con bloques visuales.",
    "toolkit.inclusionGtTitle": "Educación inclusiva — UNICEF Guatemala",
    "toolkit.inclusionGtDesc": "Información oficial sobre educación e inclusión en Guatemala.",
